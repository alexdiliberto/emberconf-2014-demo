...
window.startApp          = require('emberconf-2014-demo/tests/helpers/start_app')['default'];
window.isolatedContainer = require('emberconf-2014-demo/tests/helpers/isolated_container')['default'];
